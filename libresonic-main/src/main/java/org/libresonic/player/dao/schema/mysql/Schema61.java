...
public class Schema61 extends Schema {
    ...
    public void execute(JdbcTemplate template) {
        ...
        if (!columnExists(template, "last_fm_enabled", "user_settings")) {
            ...
            template.execute("ALTER TABLE user_settings add last_fm_username VARCHAR(255) null");
            template.execute("ALTER TABLE user_settings add last_fm_password VARCHAR(255) null");
        ...
        if (!columnExists(template, "transcode_scheme", "user_settings")) {
            ...
            template.execute("ALTER TABLE user_settings add transcode_scheme VARCHAR(255) default '" +
        ...
        if (!columnExists(template, "avatar_scheme", "user_settings")) {
            ...
            template.execute("ALTER TABLE user_settings add avatar_scheme VARCHAR(255) default 'NONE' NOT NULL");
        ...
        if (!columnExists(template, "email", "user")) {
            ...
            template.execute("ALTER TABLE user add email VARCHAR(255)");
        ...
        if (!tableExists(template, "transcoding2")) {
            ...
            template.execute("create table transcoding2 (" +
                             "id INT NOT NULL AUTO_INCREMENT," +
                             "name VARCHAR(255) NOT NULL," +
                             "source_formats VARCHAR(255) NOT NULL," +
                             "target_format VARCHAR(255) NOT NULL," +
                             "step1 VARCHAR(255) NOT NULL," +
                             "step2 VARCHAR(255)," +
                             "step3 VARCHAR(255)," +
        ...
        if (!columnExists(template, "imported_FROM", "playlist")) {
            ...
            template.execute("ALTER TABLE playlist add imported_FROM VARCHAR(255)");
        ...
        if (!columnExists(template, "genre", "album")) {
            ...
            template.execute("ALTER TABLE album add genre VARCHAR(255)");
        ...
        if (!columnExists(template, "default_album_list", "user_settings")) {
            ...
            template.execute("ALTER TABLE user_settings add default_album_list VARCHAR(255) default '" +
        ...
        if (!columnExists(template, "image_url", "podcast_channel")) {
            ...
            template.execute("ALTER TABLE podcast_channel add image_url VARCHAR(255)");
